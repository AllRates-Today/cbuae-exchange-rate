// Central Bank of the UAE exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/cbuae';
...
/** Latest rate for one pair, e.g. getRate('USD', 'AED', { apiKey }). */
